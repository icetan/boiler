...
(function() {
  var Boiler, Pot, boilerCacheCleared, debug, hasProp, path_, relativeModule, toDict,
    __slice = [].slice,
    __indexOf = [].indexOf || function(item) { for (var i = 0, l = this.length; i < l; i++) { if (i in this && this[i] === item) return i; } return -1; };

  boilerCacheCleared = false;
  ...
  Boiler = (function() {
    ...
    Boiler.getHook = function(pot, ext, func) {
      ...
      hook = function(module_, filename) {
        var cmp, isBoiler, msg;
        isBoiler = path_.basename(module_.filename, '.js') === 'boiler';
